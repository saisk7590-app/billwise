    ...
    <MobileContainer>
      ...
      <div className="bg-gradient-to-br from-blue-500 to-purple-600 px-6 pt-8 pb-6 rounded-b-3xl">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-white text-xl font-semibold">Subscriptions</h1>
        </div>
        <p className="text-blue-100 text-sm mt-1 ml-14">{currentMonth}</p>
      </div>
      ...
      <div className="px-4 -mt-4 space-y-6">
        ...
        <div
          ...
          onClick={() => navigate('/subscriptions/analytics')}
        >
          ...
          {topCategoriesKPI.map((cat) => {
            ...
            return (
              <div
                ...
                onClick={() => navigate('/subscriptions/analytics?tab=stats&category=' + cat.category)}
              >
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          ...
          <div className="mb-3" style={{ height: '160px' }}>
          ...
          <div className="space-y-4">
            {topServices.map((service) => (
              <div
                ...
                onClick={() => navigate(`/subscriptions/service/${service.serviceName}`)}
              >
                <div>
